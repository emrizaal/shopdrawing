...
<div id="page-wrapper">
  <div class="row">
    <div class="col-sm-12">
      <h3>Edit Admin</h3>
      <hr>
      <form class="form-horizontal" action="<?=base_url('Admin/prosesEditAdmin')?>" method="POST">
        <input type="hidden" name="id_admin" value="<?=$data['id_admin']?>">
        <div class="form-group">
          <label class="control-label col-sm-3" for="judul_gambar">Nama:</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="judul_gambar" placeholder="Masukkan Nama" name="nama" autofocus value="<?=$data['nama']?>">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3" for="nomor_shop_drawing">Username:</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="nomor_shop_drawing" placeholder="Masukkan Username" name="username" value="<?=$data['username']?>">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <span style="color:red">*kosongkan password apabila tidak ingin merubah password</span>
          </div>
        </div>
        <hr>
        <div class="form-group">        
