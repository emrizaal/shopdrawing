...
<div id="page-wrapper">
	<div class="row">
		<div class="col-sm-12">
			<h3>Edit Gambar</h3>
			<hr>
			<form class="form-horizontal" action="<?=base_url('Shopdrawing/updateGambar')?>" method="POST">
				<input type="hidden" name="id_detail_shop_drawing" value="<?=$data['id_detail_shop_drawing']?>">
				<input type="hidden" name="id" value="<?=$data['id_shopdrawing']?>">
				<div class="form-group">
					<label class="control-label col-sm-3" for="judul_gambar">Judul Gambar:</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="judul_gambar" placeholder="Masukkan Judul Gambar" name="nama_shop_drawing" value="<?=$data['nama_shop_drawing']?>">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-3" for="nomor_shop_drawing">Nomor Shop Drawing:</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="nomor_shop_drawing" placeholder="Masukkan Nomor Gambar" name="nomor_shop_drawing" value="<?=$data['nomor_shop_drawing']?>">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">        
					<div class="col-sm-offset-3 col-sm-9">
						...
						<a href="<?=base_url('Shopdrawing/detailDokumen/'.$data['id_shopdrawing'])?>" class="btn btn-default">Kembali</a>
					</div>
				</div>
			</form>
		</div>
