...
<div id="page-wrapper">
	<div class="row">
		<div class="col-sm-12">
			<h3>Tambah Gambar</h3>
			<hr>
			<form class="form-horizontal" action="<?=base_url('Builddrawing/addGambar')?>" method="POST">
				...
				<div class="form-group">
					<label class="control-label col-sm-3" for="nomor_shop_drawing">Nomor As Build Drawing:</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="nomor_shop_drawing" placeholder="Masukkan Nomor Gambar" name="nomor_as_build_drawing">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">        
					<div class="col-sm-offset-3 col-sm-9">
						...
						<a href="<?=base_url('Builddrawing/detailDokumen/'.$id)?>" class="btn btn-default">Kembali</a>
					</div>
				</div>
			</form>
		</div>
