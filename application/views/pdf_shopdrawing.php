	...
	<table>
		<tbody>
			<tr>
				...
				<td width="33.3%" class="text-center br-all">Pengajuan Shop Drawing</td>
			</tr>
		</tbody>
	</table>
	<table>
		...
		<tr class="br-all">
			<td colspan="6">Dengan hormat, <br> Mohon komentar dan persetujuan atas Shop Drawing yang kami ajukan dibawah ini untuk acuan pelaksanaan dilapangan : </td>
		</tr>
	</table>
	<table>
		<tr class="br-all-td text-center text-bold">
			<td>No</td>
			<td>No.Shop Drawing</td>
			<td colspan="2">Nama Shop Drawing</td>
			<td>Status</td>
			<td>Ref.Gambar No.</td>
		</tr>
		<?php
