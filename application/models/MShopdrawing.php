...
class MShopdrawing extends CI_Model {
	...
	function editDokumen($param){
		$query=$this->db->query("UPDATE shopdrawing SET nomor_dokumen='$param[nomor_dokumen]', tanggal_pengajuan='$param[tanggal_pengajuan]', tanggal_pembuatan='$param[tanggal_pembuatan]', id_admin='$param[id_admin]', status='$param[status]', tanggal_edit='$param[tanggal_edit]', edit_oleh='$param[edit_oleh]' WHERE id_shopdrawing='$param[id_shopdrawing]'");
		return $query;
	}
